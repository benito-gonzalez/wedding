...
SECRET_KEY = '$q+a7vep6374sj)sb1!7d8agg6mz0xc503!%!um6n$d!d5qzvi'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, '../app_wedding/static/')
...
EMAIL_PORT = 587
EMAIL_RECIPIENT_LIST = ['gon.beni@gmail.com', 'eugenia.sanchez.rodriguez@gmail.com']
